...
export function Dashboard() {
  ...
  const handlePeriodChange = (newPeriod: MetricsPeriod, from?: string, to?: string) => {
    setPeriod(newPeriod);
    setCustomFrom(from);
    setCustomTo(to);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <TrendsCharts project={project} period={period} from={customFrom} to={customTo} />
      ...
      >
        ...
        {drillDown === 'tokens' && (
          <TokensDrillDown period={period} project={project} from={customFrom} to={customTo} />
        )}
        {drillDown === 'duration' && (
          <DurationDrillDown period={period} project={project} from={customFrom} to={customTo} />
        )}
      </DrillDownPanel>
    </div>
  );
